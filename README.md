...
| --- | --- | --- | --- |
| **Hawser** | [![Builder][builder-shield]][builder-workflow] <br> Lightweight Go agent that lets [Dockhand](https://github.com/Finsys/dockhand) manage Docker hosts behind firewalls, NATs or in cluster setups. | [hawser/README.md](hawser/README.md) | [![Builder][builder-shield]][builder-workflow] |
